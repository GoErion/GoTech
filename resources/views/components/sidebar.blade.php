<div>
    <section>
        <div class="border border-slate-900 rounded-2xl p-4">
            <div class="flex items-center justify-center p-3 bg-slate-900 rounded-3xl">
                <div class="block">
                    <h1 class="text-2xl">
                        Dashboard
                    </h1>
            ...
            <ul class="space-y-2 mt-8">
                <li>
                    <a href="{{ route('profile.edit') }}" class="flex items-center bg-slate-900 px-2 py-1.5 rounded-lg">
                ...
                <li>
                    <a href="{{ route('forum') }}" class="flex items-center bg-slate-900 px-2 py-1.5 rounded-lg">
                ...
                <li>
                    <a href="{{ route('services') }}" class="flex items-center bg-slate-900 px-2 py-1.5 rounded-lg">
                        <svg class="shrink-0 w-5 h-5 transition duration-75 group-hover:text-fg-brand" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 13h3.439a.991.991 0 0 1 .908.6 3.978 3.978 0 0 0 7.306 0 .99.99 0 0 1 .908-.6H20M4 13v6a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1v-6M4 13l2-9h12l2 9M9 7h6m-7 3h8"/></svg>
                        <span class="flex-1 ms-3 whitespace-nowrap">Services</span>
                    </a>
                </li>
                <li>
                    <a href="#" class="flex items-center bg-slate-900 px-2 py-1.5 rounded-lg">
                ...
                @auth
                    <li>
                        <form action="{{ route('logout') }}" method="post">
                            @csrf
                            <div class="flex items-center bg-slate-900 px-2 py-1.5 rounded-lg">
